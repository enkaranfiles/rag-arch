...
from llama_index.core.node_parser import HTMLNodeParser, JSONNodeParser, MarkdownNodeParser
...
def generate_rag_pipeline(file, llm, embed_model, node_parser, response_mode, vector_store):
    ...
    vector_index = VectorStoreIndex.from_documents(documents=file, storage_context=storage_context, show_progress=True, llm=llm, embed_model=embed_model, node_parser=node_parser)
    if storage_context:
